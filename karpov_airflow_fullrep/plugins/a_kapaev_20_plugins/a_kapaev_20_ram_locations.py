...
class AKapaev20ramlocation (BaseOperator):
...
#         sql_query0 = '''TRUNCATE TABLE a_kapaev_20_ram_location'''
#         cursor.execute(sql_query0)
#         conn.commit()

# Запишите значения соответствующих полей этих трёх локаций в таблицу.
        sql_query1 = f'''INSERT INTO a_kapaev_20_ram_location VALUES {','.join(result_data)}'''
