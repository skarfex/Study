...
class AGaleeva21RickMortyHook(HttpHook):
    """
...
class AGaleeva21RamDeadOrAliveCountOperator(BaseOperator):
    """
    Count number of dead or alive characters
    On AGaleeva21RickMortyHook
    """
    ...
    def execute(self, context):
        ...
        """
        hook = AGaleeva21RickMortyHook('a_galeeva_21_ram')
