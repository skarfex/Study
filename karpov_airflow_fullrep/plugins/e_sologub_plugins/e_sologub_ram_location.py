...
class ESologubRamLocationHook(HttpHook):
...
class ESologubRamLocationOperator(BaseOperator):
    ...
    def execute(self, context):
        hook = ESologubRamLocationHook('dina_ram')
        location_list = []
        ...
        insert_sql = f"INSERT INTO e_sologub_ram_location VALUES {','.join(insert_values)}"
