...
class MShabunjaRamLocationOperator(BaseOperator):
    ...
    def execute(self, context):
        ...
        sql_query = f'INSERT INTO m_shabunja_14_ram_location (id, name, type, dimension, resident_cnt) VALUES {data_to_insert}'
