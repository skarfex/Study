...
class RaboRickMortyHook(HttpHook):
    """
...
class RaboRAMLocOperator(BaseOperator):
    """Top three locations of count resident on RaboRickMortyHook"""
    ui_color = "#c7ffe9"
    ...
    def execute(self, context: Any) -> None:
        locations = []
        hook = RaboRickMortyHook('dina_ram')
