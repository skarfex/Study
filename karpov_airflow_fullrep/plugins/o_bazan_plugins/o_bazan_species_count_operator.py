...
class OBazanSpeciesCountOperator(BaseOperator):

    template_fields = ('species_type',) # определяем кортеж объектов, которые могут быть шаблонизированы (заданы в таске)
    ui_color = "#FF00FF" # задаем цвет оператора
