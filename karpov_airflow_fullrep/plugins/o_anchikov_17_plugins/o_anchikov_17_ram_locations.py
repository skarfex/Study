...
from o_anchikov_17_plugins.o_anchikov_17_api_hook import oanchikov_apihook
import logging


class oanchikovRAMLocationOperator(BaseOperator):
    ...
    def execute(self, context):
        ...
        api_hook = oanchikov_apihook('dina_ram')
