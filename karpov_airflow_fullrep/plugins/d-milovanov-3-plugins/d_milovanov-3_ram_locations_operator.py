...
class DMilovanovRickMortyHook(HttpHook):
    """
...
class DMilovanovRAMAPILocationsOperator(BaseOperator):
    """Top3 locations of resident_cnt on DMilovanovRickMortyHook"""
    ui_color = "#cfb53b"
    ...
    def execute(self, context: Any) -> None:
        locations = []
        hook = DMilovanovRickMortyHook('dina_ram')
