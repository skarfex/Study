...
class eponomarevaRickMortyHook(HttpHook):
    """
    ...
    def __init__(self, http_conn_id: str, **kwargs) -> None:
        ...
        self.method = 'GET'    #добавили метод для работы по умолчанию (чтение)
...
class eponomarevaRamDeadOrAliveCountOperator(BaseOperator):
    """
    ...
    def execute(self, context):
        ...
        """
        hook = eponomarevaRickMortyHook('eponomareva_ram')
