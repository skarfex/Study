...
from d_severinets_plugins.d_severinets_ram_hook import SeverinetsRamHook


class SeverinetsGetTopRamLocationsOperator(BaseOperator):
    ...
    def execute(self, context):
        ...
        ram_hook = SeverinetsRamHook('dina_ram')
