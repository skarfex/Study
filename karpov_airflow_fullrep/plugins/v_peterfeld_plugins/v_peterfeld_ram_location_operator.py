# -*- coding: utf-8 -*-
"""
conn hook and top ram location operator
"""
...
class VpeterfeldRamHook(HttpHook):
...
class VpeterfeldGetTopRamLocationsOperator(BaseOperator):
    ...
    def execute(self, context):
        ram_hook = VpeterfeldRamHook('dina_ram')
        ...
        logging.info(self._get_sql_values(top_locations))
