"""
5 урок
DAG по загрузке топ 3 локаций из апи Рика и Морти
"""
...
import logging
from a_bagina_19_plugins.a_bagina_ram_top_location_operator import (
    ABaginaRamTopLocationOperator,
)
...
with DAG(
    ...
    top_location = ABaginaRamTopLocationOperator(
    ...
    create_new_table = PostgresOperator(
        ...
        sql="""
            CREATE TABLE IF NOT EXISTS public.a_bagina_19_ram_location
            (
                id INT4 NOT NULL,
    ...
    def load_df_to_gp(**kwargs):
        ...
        pg_hook.run("TRUNCATE TABLE public.a_bagina_19_ram_location", True)
        ...
        pg_hook.insert_rows(
            "public.a_bagina_19_ram_location", df_location, commit_every=3
        )
