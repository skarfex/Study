...
Реализация без кастомного хука
...
from o_bazan_plugins.o_bazan_top_location_count_operator import TOPLocationOperator
...
dag = DAG(
    dag_id = "o-bazan_lesson5_without_hook_dag",
...
top3_location_task = TOPLocationOperator(
