...
from i_muravev_plugins.i_muravev_rick_and_morty_operator import TopLocationsRickAndMorty
...
with DAG("i-muravev_rick_and_morty",
         schedule_interval=None,
         default_args=DEFAULT_ARGS,
         max_active_runs=1,
         tags=['i-muravev', 'i-muravev_rick_and_morty']
         ) as dag:
    ...
    create_or_truncate_table = PostgresOperator(
        ...
        sql=[
            '''
            CREATE TABLE IF NOT EXISTS "i_muravev_ram_location"
            (
                ...
                DISTRIBUTED BY (id);''',
            '''TRUNCATE TABLE "i_muravev_ram_location";'''
        ],
        autocommit=True
    )
