...
from s_abdibekov_plugins.s_abdibekov_ram_species_count_operator import SultanRamSpeciesCountOperator
from s_abdibekov_plugins.s_abdibekov_ram_dead_or_alive_operator import SultanRamDeadOrAliveCountOperator
from s_abdibekov_plugins.s_abdibekov_random_sensor import SultanRandomSensor
...
with DAG("s-abdibekov-17_load_ram",
    ...
    random_wait = SultanRandomSensor(task_id='random_wait', mode='reschedule')
    ...
    print_alien_count = SultanRamSpeciesCountOperator(
        task_id='print_alien_count',
        species_type='Alien'
    )

    print_dead_count = SultanRamDeadOrAliveCountOperator(
